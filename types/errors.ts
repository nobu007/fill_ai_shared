...
export const ERROR_MESSAGES = {
  ...
  userDataInvalidJson: 'user_data の形式が不正です。有効なJSON配列を指定してください。',
  userDataNotArray: 'user_data は配列形式で指定してください。',
  userDataItemInvalid: 'user_data の各項目には label, category, value (文字列) が必要です。',
