...
export const ENV_VAR_NAMES = [
  ...
  'FILL_USER_DATA_RAW_MAX_LENGTH',
  'FILL_MAPPINGS_RAW_MAX_LENGTH',
  'FILL_MODEL_OVERRIDE_MAX_LENGTH',
  'FILL_MATCHER_ID_MAX_LENGTH',
  'FILL_CORRECTION_SESSION_ID_MAX_LENGTH',
  'FILL_HISTORY_MAX_ITEMS',
  'FILL_HISTORY_RANDOM_ID_LENGTH',
  ...
  'FILL_HIGH_CONFIDENCE_THRESHOLD',
  'FILL_RULE_MATCH_THRESHOLD',
  'FILL_DEFAULT_MATCHER_ID',
  'FILL_ALERT_ERROR_RATE_THRESHOLD',
  'FILL_ALERT_RESPONSE_TIME_THRESHOLD_MS',
  'FILL_ALERT_TOKEN_THRESHOLD',
  'FILL_API_P99_SLA_MS',
  // T-016 Fallback Telemetry (CM-414 §2.4 sentinel — gate for JSONL appender)
  'FILL_TELEMETRY_DISABLED',
  'UI_TOAST_TIMEOUT_MS',
  'UI_SYNC_MESSAGE_TIMEOUT_MS',
  'TEMPLATES_NAME_MAX_LENGTH',
  ...
  'LLM_CACHE_PROVIDER',
  // Quality Evaluation
  'SCORE_AUTO_FIXED_PENALTY',
  'SCORE_NEEDS_REVIEW_PENALTY',
  'SCORE_AXIS_PATCH_PENALTY',
  'DIAGNOSE_OVERALL_TIMEOUT_MS',
  // OpenRouter
  'OPENROUTER_API_URL',
  'OPENROUTER_API_KEY',
  'OPENROUTER_MODEL',
